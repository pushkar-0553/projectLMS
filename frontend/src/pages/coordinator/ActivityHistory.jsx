...
import { History, Clock, Tag, Activity, Calendar, Filter, Search, RefreshCw, Layout } from 'lucide-react';
...
const ActivityHistory = () => {
  ...
  const fetchHistory = async () => {
    try {
      setLoading(true);
      const response = await coordinatorAPI.getHistory();
  ...
  return (
    <div className="activity-history-page fade-in">
      {/* Header Section */}
        ...
        <div className="container header-container">
          <div className="header-content">
            <div className="welcome-text">
              ...
              <p>Chronological audit of your administrative actions and task assignments.</p>
            </div>
      ...
      <main className="container main-content">
          ...
          <div className="filter-group">
            ...
            <div className="filter-chips">
              {[
                ...
                { id: 'subbatch', label: 'Sub-Batches' },
                { id: 'task', label: 'Tasks' },
                { id: 'submission', label: 'Reviews' },
                { id: 'user', label: 'Assignments' }
              ].map(type => (
                <button
                  key={type.id}
        ...
        <div className="table-card card fade-in">
          <div className="table-wrapper">
            <table className="modern-table activity-table">
              <thead>
                <tr>
                  ...
                  <tr>
                    <td colSpan="4">
                      <div className="empty-state-inner">
                        ...
                        <p>Your institutional activity stream will appear here.</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                  filteredHistory.map((log) => (
                    <tr key={log.id} className="table-row">
                      ...
                      <td className="id-cell">
                        <span className="entity-id-ref">ID-{log.entity_id || 'LOCAL'}</span>
                      </td>
                    </tr>
                  ))
                )}
      ...
      <style>{`
        ...
        .timestamp-cell { width: 180px; }
        .date-str { font-weight: 700; color: #0f172a; font-size: 0.9rem; }
        .time-str { color: #94a3b8; font-size: 0.75rem; font-weight: 500; }
        ...
        .details-icon { color: #cbd5e1; flex-shrink: 0; }
        .description-text { font-size: 0.9rem; color: #475569; margin: 0; }
        
        .id-cell { width: 140px; text-align: right; }
        ...
        @media (max-width: 768px) {
          ...
          .timestamp-cell, .action-cell, .id-cell { min-width: 120px; }
        }
      `}</style>
    </div>
  );
