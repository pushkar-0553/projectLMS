-- Targeted Platform Migration Script
...
-- ProjectSteps table (mapping from existing Steps)
...
INSERT IGNORE INTO ProjectSteps (project_id, title, description, step_order, estimated_hours, images)
SELECT 
    s.project_id,
    s.title,
    s.explanation,
...
SELECT 'Targeted platform migration completed successfully!' as status;
